...
##/usr/pgsql-9.4/bin/psql -U doleynik_rw -h eridanus nispd < 01-nnp-make-triggers-in-nispd.sql  
##/usr/pgsql-9.4/bin/psql -U doleynik_rw -h eridanus nispd < event.queue.notify.all.sql
