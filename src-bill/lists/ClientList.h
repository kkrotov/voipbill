...
protected:
    ...
    string sql(BDb * db) {
        return "   select id, voip_limit_day, credit, balance, amount_date, voip_disabled, organization_id, price_include_vat, timezone_offset, is_blocked, anti_fraud_disabled " \
