...
bool BillClient::sendrecv(string &msg, string &res) {
    ...
    try {
        ...
        udp::endpoint endpoint(addr, 8033);
...
string BillClient::query(string aNumber, string bNumber, string trunkName) {

    string msg = "calling:" + aNumber + ";called:" + bNumber + ";trunk:" + trunkName;
    string res;
